...
class Settings(BaseSettings):
    ...
    # === Project ===
    PROJECT_NAME: str = "openstudyindiaai"
    ...
    LOGFIRE_SERVICE_NAME: str = "openstudyindiaai"
    ...
    POSTGRES_DB: str = "openstudyindiaai"
    ...
    S3_ACCESS_KEY: str = ""
    S3_SECRET_KEY: str = ""
    S3_BUCKET: str = "openstudyindiaai"
    ...
    LANGCHAIN_PROJECT: str = "openstudyindiaai"
